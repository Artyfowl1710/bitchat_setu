...
class BitchatApplication : Application() {
    ...
    override fun onCreate() {
        ...
        try {
            val hasAware = com.bitchat.android.wifiaware.WifiAwareSupport.evaluate(this).supported
            val enabled = com.bitchat.android.ui.debug.DebugPreferenceManager.getWifiAwareEnabled(hasAware)
